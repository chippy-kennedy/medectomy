...
class ApplicationController < ActionController::Base
 ...
 def disqus_sso(user)
  ...
  def configure_permitted_parameters
    ...
    devise_parameter_sanitizer.for(:account_update) {|u| u.permit(:first_name, :last_name, :email, :degree, :graduation_year, :description, :facebook_id, :twitter_handle, :linkedin_id, :password, :password_confirmation, :current_password) }
